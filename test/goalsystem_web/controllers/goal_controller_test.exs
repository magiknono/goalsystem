defmodule GoalsystemWeb.GoalControllerTest do
  use GoalsystemWeb.ConnCase

  alias Goalsystem.Personnal

  @create_attrs %{completed: true, name: "some name", selected: true}
  @update_attrs %{completed: false, name: "some updated name", selected: false}
  @invalid_attrs %{completed: nil, name: nil, selected: nil}

  def fixture(:goal) do
    {:ok, goal} = Personnal.create_goal(@create_attrs)
    goal
  end
